...
class ReuseContainerEyePage extends StatefulWidget {
  const ReuseContainerEyePage(
      {Key? key,
  ...
  @override
  State<ReuseContainerEyePage> createState() => _ReuseContainerEyePageState();
}

class _ReuseContainerEyePageState extends State<ReuseContainerEyePage> {
  @override

...
class ReuseContainerJonurnalistPage extends StatefulWidget {
  const ReuseContainerJonurnalistPage(
      {Key? key,
  ...
  @override
  State<ReuseContainerJonurnalistPage> createState() =>
      _ReuseContainerJonurnalistPageState();
}

class _ReuseContainerJonurnalistPageState extends State<ReuseContainerJonurnalistPage> {
  @override

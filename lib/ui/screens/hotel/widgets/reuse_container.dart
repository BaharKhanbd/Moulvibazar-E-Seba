...
class ReuseContainerHotelPage extends StatefulWidget {
  const ReuseContainerHotelPage(
      {Key? key,
  ...
  @override
  State<ReuseContainerHotelPage> createState() =>
      _ReuseContainerHotelPageState();
}

class _ReuseContainerHotelPageState extends State<ReuseContainerHotelPage> {
  @override

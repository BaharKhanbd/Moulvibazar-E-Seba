...
class ReuseContainerHospitalPage extends StatefulWidget {
  const ReuseContainerHospitalPage(
      {Key? key,
  ...
  @override
  State<ReuseContainerHospitalPage> createState() =>
      _ReuseContainerHospitalPageState();
}

class _ReuseContainerHospitalPageState extends State<ReuseContainerHospitalPage> {
  @override

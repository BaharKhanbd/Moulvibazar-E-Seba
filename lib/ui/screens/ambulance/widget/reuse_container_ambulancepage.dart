...
class ReuseContainerAmbulancePage extends StatefulWidget {
  const ReuseContainerAmbulancePage(
      {Key? key,
  ...
  @override
  State<ReuseContainerAmbulancePage> createState() =>
      _ReuseContainerAmbulancePageState();
}

class _ReuseContainerAmbulancePageState extends State<ReuseContainerAmbulancePage> {
  @override

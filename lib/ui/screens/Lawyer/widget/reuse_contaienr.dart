...
class ReuseContainerLawyerPage extends StatefulWidget {
  const ReuseContainerLawyerPage(
      {Key? key,
  ...
  @override
  State<ReuseContainerLawyerPage> createState() =>
      _ReuseContainerLawyerPageState();
}

class _ReuseContainerLawyerPageState extends State<ReuseContainerLawyerPage> {
  @override
